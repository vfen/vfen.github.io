...
jQuery(document).ready(function ($) {
    ...
    $(".mumu").mouseover(function () {
       $(".mumu").fadeTo("300", 0.3);
       msgs = ["带上小宝宝，我就跟你玩~", "本小助理可远观不可亵玩！", "我会隐身哦！嘿嘿！", "别动手动脚的，把手拿开！！", "再不把手拿开小心我横竖竖你！！", "小奋豆，他摸我，呜呜呜呜~~~", "你把手拿开我就出来！"];
...
jQuery(document).ready(function ($) {
    ...
    window.setInterval(function () {
        msgs = ["只有您的支持，小奋豆才能有收入、才能靠专心制作最优秀的视频教程活下去、才能无条件持续给大家提供一个优秀的学习互助平台！", "好无聊哦，你都不陪我玩~", "…@……!………", "^%#&*!@*(&#)(!)(", "我是小奋豆的小小助理哦~_~", "我可爱吧！嘻嘻!~^_^!~~","谁淫荡呀?~谁淫荡?，你淫荡呀!~~你淫荡！~~","从前有座山，山上有座庙，庙里有个老和尚给小和尚讲故事，讲：“从前有座……”"];
        var i = Math.floor(Math.random() * msgs.length);
...
jQuery(document).ready(function ($) {
    window.setInterval(function () {
        msgs = ["只有您的支持，小奋豆才能有收入、才能靠专心制作最优秀的视频教程活下去、才能无条件持续给大家提供一个优秀的学习互助平台！", "乾坤大挪移！", "我飘过来了！~", "我飘过去了", "我得意地飘！~飘！~"];
        var i = Math.floor(Math.random() * msgs.length);
